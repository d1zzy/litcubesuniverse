...
### November 14, 2014
  ...
  * (-) Changed: FLC nerfed; see [FLC](Feature_FLC)
...
### Holy Month of Joubarbe 20, 2014
  ...
  * *Code base: [Sloth](http://en.wikipedia.org/wiki/Sloth)*
...
### Holy Month of Joubarbe 19, 2014
  ...
  * (-) Changed: Station Agent behaviour completely changed (See: [Station Agent](Feature_Station_Agent))
